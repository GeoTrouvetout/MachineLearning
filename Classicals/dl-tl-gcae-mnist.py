...
"""
Copyright 2017 Université de Nantes

Created on Jan 2017

@author: Geoffrey ROMAN JIMENEZ
@contact : grj@mailoo.org
@github : https://gitlab.univ-nantes.fr/CIRESFI/MachineLearning
...
def main(num_epochs=10):
	...
	# network output and defintion of traning/validation/test functions
	...
	for epoch in range(num_epochs):
		...
		for batch in iterate_minibatches(X_train, X_train, y_train, 100, shuffle=True):
			...
			print("\t training loss recon:\t\t{:.6f} ".format(train_err_enc / train_batches) )
